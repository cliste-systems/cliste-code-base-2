 ...
 */
import { buildDemoPersonaGreeting, DEMO_LINE_OPENING, pickCallPersona } from '../src/lib/persona.js';
...
console.info(`Demo spoken opening (fixed): ${DEMO_LINE_OPENING}\n`);
...
for (let i = 0; i < count; i += 1) {
  ...
  console.info(`  Spoken: ${spokenOpening}`);
